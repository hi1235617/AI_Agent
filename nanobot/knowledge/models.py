...
class Note(BaseKnowledgeModel):
    ...
    created_at: Optional[datetime] = Field(default=None, alias="createdAt", description="Creation timestamp")
    updated_at: Optional[datetime] = Field(default=None, alias="updatedAt", description="Last modification timestamp")
